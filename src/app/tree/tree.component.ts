...
export class TreeComponent implements OnInit, OnChanges, OnDestroy {
  ...
  async makeVegaSpec(width, height) {
    ...
    let a = new VegaConfig();
    const config: any = await a.makeVegaConfig(this.currentSheet, this.bimodalDistance, height, width, this.treeData, this.multiParentLinksData);
