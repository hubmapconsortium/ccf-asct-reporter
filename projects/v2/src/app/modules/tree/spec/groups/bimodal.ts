      ...
      encode: {
        ...
        update: {
          ...
          stroke: [
            ...
            {
              test:
                'datum.target.id === node__hover && datum.source.group == 3',
              value: '#984EA3',
            }, // for hover
            {
              test:
            ...
            {
              test:
                'datum.source.id === node__click && datum.source.group == 3',
              value: '#984EA3',
            }, // for click
            {
              test:
            ...
            // for getting AN -> B -> CT -> AS
            {
              test:
                'indata(\'sources_hovered_array\', \'id\', datum.target.id) && datum.source.group != 4',
              value: '#4DAF4A',
            },
            {
              test:
